...
class Student(models.Model):
    ...
    student_id= models.CharField(unique=True, max_length=15)
    ...
    modified_by = models.ForeignKey(User, on_delete=models.PROTECT, related_name='students_modified', null=True, blank= True)
