...
SECRET_KEY = 'django-insecure-x@!4&28x+b7_(x(+588e1=e8ku081@^06%xx8lthcb4u_#$uyv'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': [
        ...
        'rest_framework.authentication.SessionAuthentication',  # Default: Use token-based authentication
    ],
